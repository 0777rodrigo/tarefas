...
def adicionar_tarefa():
    tarefa = tarefa_entrada.get().strip().capitalize()
    if tarefa:
...
remove_botao = ctk.CTkButton(janela, text='Remover tarefas', font=font2, text_color='white', fg_color='red', cursor='hand2', corner_radius=5, width=80, command=apagar_tarefas)
